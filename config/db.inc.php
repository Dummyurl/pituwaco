...
$B['APP_NAME'] = "News App";                            //
$B['APP_TITLE'] = "News App";                           //
$B['APP_YEAR'] = "2016";                                // Year in footer

// Your domain (host) and url! See comments! Carefully!

$B['APP_HOST'] = "news.ifsoft.ru";                 //edit to your domain, example (WARNING - without http:// and www): yourdomain.com
$B['APP_URL'] = "http://news.ifsoft.ru";           //edit to your domain url, example (WARNING - with http://): http://yourdomain.com

// Link to GOOGLE Play App in main page

$B['GOOGLE_PLAY_LINK'] = "https://play.google.com/store/apps/details?id=ru.ifsoft.news";
...
$B['GOOGLE_API_KEY'] = "456345t34534yt-43534543y34563456";
$B['GOOGLE_SENDER_ID'] = "88456456456456";
